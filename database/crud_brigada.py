...
def insertar_brigada(nombre, descripcion, coordinador, color_identificador, institucion_id=1, profesor_id=None, subjefe_id=None, tipo_brigada='ecologica'):
    """
    ...
    tipo_brigada: 'ecologica', 'riesgo', 'patrulla', 'convivencia'.
