...
- "Access denied for user 'root'" → Contraseña incorrecta: poner SBE_DB_PASSWORD en .env (XAMPP suele usar "").
...
DB_USER = os.environ.get("SBE_DB_USER", "root")
DB_PASSWORD = os.environ.get("SBE_DB_PASSWORD", "")
DB_NAME = os.environ.get("SBE_DB_NAME", "db_brigadas_maracaibo")
